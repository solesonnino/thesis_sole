...
def main():
    ...
    layout= [] #array in which i'll store all the optimal positions of the base for each object
    
    #send the place points
    place_point_send=np.array([[place_points[0]]],[[place_points[1]]],[[place_points[2]]],[[place_points[3]]],[[place_points[4]]],[[place_points[5]]], dtype=np.int32)
